...
def main() -> None:
    ...
    parser.add_argument("--tensor-dataset", type=Path, default=None, help="Train from a compact tensor dataset produced by scripts/v3_combat/cache_v3_combat_tensor_dataset.py.")
