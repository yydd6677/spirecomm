...
collect_rollout() {
  ...
  run_cmd "$PYTHON_BIN" scripts/run_value/collect_run_value_trajectories.py \
...
train_value() {
  ...
  run_cmd "$PYTHON_BIN" scripts/run_value/train_run_value_model.py \
    --input-dir "$input_dir" \
    --cache-dir "$cache_dir" \
    --output "$output" \
    --rebuild-cache \
...
build_qenv() {
  ...
  run_cmd "$PYTHON_BIN" scripts/run_value/build_run_action_policy_dataset.py \
    --output-dir "$output_dir" \
...
train_policy() {
  ...
  run_cmd "$PYTHON_BIN" scripts/run_value/train_run_action_policy.py \
    --input-dir "$input_dir" \
    --cache-dir "$cache_dir" \
    --output "$output" \
    --rebuild-cache \
