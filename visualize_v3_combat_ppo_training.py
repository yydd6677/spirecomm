...
<text x="80" y="210" fill="#6f7f99" font-size="13">Run train_v3_combat_ppo.py until at least one update writes ppo_metrics.jsonl, then rerun this visualizer.</text>
</svg>
'''
